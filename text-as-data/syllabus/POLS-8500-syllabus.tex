...
%\chead{ \fancyplain{}{} }
\rhead{ \fancyplain{}{Maymester 2026} }%\today
...
\textbf{Professor:} & Joe Ornstein & & &  & \textbf{Time:} & MTWThF 12:30pm -- 3:15pm \\
...
\subsection*{Day 11-13: Large Language Models}

\textit{Take a massive semi-supervised neural network, train it on the entire Internet, and see what happens. How do we make principled use of these things for social science measurement?}

\begin{itemize}
	\item GSR Section 8.5
	\item Ornstein, Joseph T., Elise N. Blasingame, and Jake S. Truscott. “How to Train Your Stochastic Parrot: Large Language Models for Political Texts.” \textit{Political Science Research and Methods} 13, no. 2 (2025): 264–81.
	\item Halterman, Andrew, and Katherine A. Keith. “Codebook LLMs: Evaluating LLMs as Measurement Tools for Political Science Concepts.” \textit{Political Analysis}, 2025, 1–17.
	 %\href{https://dugas.ch/artificial_curiosity/GPT_architecture.html}{GPT-3 On A Napkin} (optional, for a deeper dive into how large language models work).
...
\subsection*{Day 14: Pairwise Comparisons}

\textit{A principled approach to estimating latent scales from text.}
...
\begin{itemize}
	...
	\item Licht, Hauke, Rupak Sarkar, Patrick Y. Wu, et al. “Measuring Scalar Constructs in Social Science with LLMs.” In \textit{Proceedings of the 2025 Conference on Empirical Methods in Natural Language Processing}, 2025.
	\item Ornstein, Joseph T. (2026). ``Estimating Latent Quantities from Pretrained Text Embeddings'', \textit{Working Paper}.
