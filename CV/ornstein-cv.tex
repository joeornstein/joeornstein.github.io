...
\begin{publist}
	...
	\item Rugged Landscapes: Complexity and Implementation Science (with Ross C. Brownson, Ross A. Hammond, Margaret Padek, and Stephanie Mazzucca). 2020. \textit{Implementation Science} (forthcoming).
...
\begin{list1}
	\item[] Introduction to Political Methodology
	\item[] Introduction to Models in Political Science
\end{list1}
