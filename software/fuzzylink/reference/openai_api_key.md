...
This function will add your OpenAI API key to your `.Renviron` file so
...
`Sys.getenv("OPENAI_API_KEY")` and will be automatically called in
...
- key:
  ...
  The API key provided to you from OpenAI formated in quotes.

- overwrite:

  If this is set to TRUE, it will overwrite an existing OPENAI_API_KEY
