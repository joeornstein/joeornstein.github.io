...
When using [GitHub](bryan-2017.pdf) to manage changes to analyses/manuscripts/slides, my most frustrating frustration occurs when I forget to add a large (>50MB) data file to my `.gitignore`. I merrily type --
